...
apply(xs.returns, 2, var, na.rm=T) 
apply(xs.returns, 2, sd, na.rm=T) 
...
TODO: izbacivanje stršećih (Erste Adriatic Equity)
...
Iako QQ grafovi pokazuju da povrati nisu normalno raspodijeljeni, radimo tu pretpostavku s obzirom na robusnost T-testa. Također pretpostavljamo nezavisnost podataka, iako je jasno da globalni događaji (kriza, teroristički napadi,...) često mogu utjecati na cijelo tržište odjednom.
...
lm(formula = (zbaktiv.2010 - capm.risk_free.2010) ~ (capm.market.2010 - capm.risk_free.2010))
```

# CAPM model 2

TODO: tablica modela (alpha / beta)
