...
fund_names <- factor(rep(c(pension_funds, investment_funds), rep(2553, 6)))
columns <- xs.returns[4:9]
fund_returns <- c(columns[1], columns[2], columns[3], columns[4], columns[5], columns[6])

anova(lm(fund_names ~ fund_returns))
```
