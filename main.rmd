...
Za H0 hipotezu uzimamo kako su sredine mirovinskih fondova i CROBEX indeksa jednake. Iz sljedećih testova zaključujemo da možemo odbaciti H0 hipotezu uz nivo značajnosti 10%.k
```{r}
