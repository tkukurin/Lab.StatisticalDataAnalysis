...
Iako testovi pokazuju da povrati nisu normalno raspodijeljeni, radimo tu pretpostavku s obzirom na robusnost T-testa. Također pretpostavljamo nezavisnost podataka, iako je jasno da globalni događaji (kriza, teroristički napadi,...) često mogu utjecati na cijelo tržište odjednom.
...
capm.risk_free.2010 <- xs.2010[c('Date', 'InterestRate')]
